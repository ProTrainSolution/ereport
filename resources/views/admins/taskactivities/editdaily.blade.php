                ...
                <div class="col-lg-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form method="post" action="/taskactivities/updatedaily">
                        @method('put')
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-2">
                              <input type="date" name="report_date" id="report_date" class="form-control @error('report_date') is-invalid @enderror" value="{{ old('report_date', $taskactivity->report_date) }}">
                              @error('report_date')
                                  <div class="invalid-feedback">
                                      {{ $message }}
                                  </div>
