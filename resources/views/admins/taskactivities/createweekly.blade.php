                ...
                <div class="col-lg-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form method="post" action="/taskactivities/storeweekly">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control tinymce-editor" rows="5" name="task_description" id="task_description">{{ old('task_description') }}</textarea>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-2">
                              <input type="number" name="task_working_hour" id="task_working_hour" class="form-control @error('task_working_hour') is-invalid @enderror">
                            ...
                            <div class="col-sm-2">
                              <input type="number" name="task_progress" id="task_progress" class="form-control @error('task_progress') is-invalid @enderror">
                              @error('task_progress')
                                  <div class="invalid-feedback">
                                      {{ $message }}
                                  </div>
