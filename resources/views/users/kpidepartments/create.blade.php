                    ...
                    <div class="card-body">
                      ...
                      <form method="post" action="/kpidepartments">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <textarea style="max-height: 50px;" class="form-control tinymce-editor" rows="5" name="target" id="target">{{ old('target') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control tinymce-editor" rows="5" name="measurement" id="measurement" >{{ old('measurement') }}</textarea>
                          </div>
                        </div>
