<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse {{ (request()->is('kpidepartment*')) ? 'show' : ''}}" data-bs-parent="#sidebar-nav">
          <li>
      ...
      <li class="nav-item">
        ...
        <ul id="managekpi-nav" class="nav-content collapse {{ (request()->is('kpis*', 'users/team', 'users/pizza/*', 'users/kpidetail/*')) ? 'show' : ''}} " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="/users/team" class="{{ (request()->is('users/team', 'users/pizza/*', 'users/kpidetail/*'))  ? 'active' : ''}}">
