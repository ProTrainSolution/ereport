          ...
          <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <h5 class="card-title">Edit Weekly Activities (KPI)<br>{{-- <small>List down your main activities of the month, the start and end date as well as the status</small> --}}</h5>


                      <!-- General Form Elements -->
                      <form method="post" action="/kpiactivities/updateweekly">
                        @method('put')
                        @csrf
                        <div class="row mb-3">
                          <input type="hidden" value="{{ $kpiactivity->id }}" name="id">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control" name="kpi_week">
                                    ...
                                    <?php
                                        $tMonth = $kpiactivity->month;
                                        $tWeek = $kpiactivity->week;
                                    ...
                                    ?>
                                    @if($tWeek > 0)
                                    <option value="{{ $tData }}"> @php echo 'Week ' . $tWeek . ' - ' . $label; @endphp</option>
                                    @else
                            ...
                            <div class="col-sm-2">
                              ...
                              <label for="currProgress" id="lblCurrProgress" class="font-weight-bold">Current Progress: <span id="currProgress"></span></label>
                              @error('kpi_progress')
                                  <div class="invalid-feedback">
                                      {{ $message }}
                                  </div>
